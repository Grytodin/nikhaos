module.exports = {
  ...
  PRESENCE: {
    ...
    MESSAGE: "ATTENTION!!! The bot is still in development.The release stage will be published on the support server below.{members} members in (servers) servers", // Status message
  },
